...
// End Cross Module References
	...
	template<> BATTLETANK_API UClass* StaticClass<ATankPawn>()
	{
		return ATankPawn::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ATankPawn);
	struct Z_CompiledInDeferFile_FID_battletank_Source_battletank_TankPawn_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_battletank_Source_battletank_TankPawn_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATankPawn, ATankPawn::StaticClass, TEXT("ATankPawn"), &Z_Registration_Info_UClass_ATankPawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATankPawn), 846167125U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_battletank_Source_battletank_TankPawn_h_1068474416(TEXT("/Script/battletank"),
		Z_CompiledInDeferFile_FID_battletank_Source_battletank_TankPawn_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_battletank_Source_battletank_TankPawn_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
